...
ActiveRecord::Schema.define(version: 20180114112539) do
  ...
  create_table "generals", force: :cascade do |t|
    ...
    t.string   "contest_mail_attachment"
    t.string   "contest_mail_attachment_PL"
    t.string   "conference_mail_attachment"
