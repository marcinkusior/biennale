...
function posterRwd(){
	...
	// var size; var poster;
	// var mdPoster = "/home/marcin/Projekty/digital_ocean_Biennale/Biennale_do/app/assets/images/poster-640.png ";
	// var lgPoster = '/assets/Poster.jpg';


	// poster = $('.poster').children('img')[0];

	// $(window).resize( function(){
	// 	size = window.innerWidth;
	// 	if(size < 768){ $(poster).attr('src', mdPoster ); }
	// 	else{ $(poster).attr('src', lgPoster ); }
	// })
...
function posterOnOpen(){
	...
	poster.css('transition', '1.2 s cubic-bezier(0.77, 0, 0.175, 1)');
	...
	$('body').bind('wheel', function(e){
		...
		if ($(window).scrollTop() === 0 && e.originalEvent.wheelDelta > 120){
			posterDown();
		...
		if( poster.offset().top > -(poster.height()) ){
...
function registration_logic(){
  ...
  $('.validate_present').change( function(){
