...
class Admin::MarkersControllerTest < ActionController::TestCase
  ...
  test "should create marker" do
    assert_difference('Marker.count') do
      post :create, marker: { desc: @marker.desc, lat: @marker.lat, lng: @marker.lng }
    end

    assert_redirected_to admin_marker_path(assigns(:marker))
  end
  ...
  test "should update marker" do
    patch :update, id: @marker, marker: { desc: @marker.desc, lat: @marker.lat, lng: @marker.lng }
    assert_redirected_to admin_marker_path(assigns(:marker))
  end
